...
const Login = () => {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (err.code === "auth/configuration-not-found") {
        setError(
          "Google Sign-In is not enabled in your Firebase Console yet. Please go to Firebase Console > Authentication > Sign-in method and enable Google provider."
        );
  ...
  return (
    <div className="auth-page">
      <motion.div
        className="auth-card google-only-card"
      ...
      >
        ...
        <div className="auth-header">
          ...
          <p>
            ...
            documents automatically with AI.
          </p>
        </div>
        ...
        <div className="auth-trust-footer">
          ...
          <p className="auth-terms-note">
            By signing in, you agree to Formio's Terms of Service and Privacy Policy.
          </p>
        </div>
      </motion.div>
    </div>
